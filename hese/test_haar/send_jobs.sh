...
sigma=0.01
nsteps=2000
outfile=/data/mandalia/flavour_ratio/data/test_haar/mcmc_chain
...
for ((i=0; i<$count; i++)); do
    ...
    /users/mandalia/Documents/flavour_triangle/hese/test_haar/wrap.sh ${arg[0]} ${arg[1]} ${arg[2]} ${sigma} ${nsteps} ${outfile}
    # break
