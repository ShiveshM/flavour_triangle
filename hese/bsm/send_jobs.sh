...
sigma=0.001
nsteps=1000
outfile=/data/mandalia/flavour_ratio/data/bsm/mcmc_chain
...
for ((i=0; i<$count; i++)); do
    ...
    /users/mandalia/Documents/flavour_triangle/hese/bsm/wrap.sh ${arg[0]} ${arg[1]} ${arg[2]} ${sigma} ${nsteps} False ${outfile}
    # break
